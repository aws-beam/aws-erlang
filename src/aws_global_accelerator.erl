...
%% Regions, which are listed in the AWS Region Table.
%%
...
%% you associate with your accelerator. (Instead of using the IP addresses
%% that Global Accelerator provides, you can configure these entry points to
%% be IPv4 addresses from your own IP address ranges that you bring to Global
%% Accelerator.) The static IP addresses are anycast from the AWS edge
%% network and distribute incoming application traffic across multiple
...
%% Global Accelerator Developer Guide. If you already have load balancers,
%% EC2 instances, or Elastic IP addresses set up for your applications, you
%% can easily add those to Global Accelerator to allow the resources to be
...
%% traffic by using them. You can use IAM policies with Global Accelerator to
%% limit the users who have permissions to delete an accelerator. For more
%% information, see Authentication and Access Control in the AWS Global
%% Accelerator Developer Guide.
%%
%% </dd> <dt>Accelerator</dt> <dd> An accelerator directs traffic to optimal
%% endpoints over the AWS global network to improve availability and
%% performance for your internet applications that have a global audience.
...
%% testing or blue/green deployment testing for new releases across different
%% AWS Regions, for example.
%%
...
%% which includes endpoints, such as Network Load Balancers. To see an AWS
%% CLI example of creating an accelerator, scroll down to Example.
%%
%% Global Accelerator is a global service that supports endpoints in multiple
%% AWS Regions but you must specify the US West (Oregon) Region to create or
%% update accelerators.
...
%% or list of port ranges that you specify. To see an AWS CLI example of
...
%%
%% To see an AWS CLI example of deprovisioning an address range, scroll down
%% to Example.
%%
...
%%
%% To see an AWS CLI example of describing the attributes of an accelerator,
...
%%
%% To see an AWS CLI example of describing a listener, scroll down to
%% Example.
...
%%
%% To see an AWS CLI example of listing the accelerators for an AWS account,
%% scroll down to Example.
...
%%
%% To see an AWS CLI example of listing the endpoint groups for listener,
%% scroll down to Example.
...
%%
%% To see an AWS CLI example of listing the listeners for an accelerator,
%% scroll down to Example.
...
%%
%% To see an AWS CLI example of listing tags for an accelerator, scroll down
%% to Example.
%%
...
%% associated value. To see an AWS CLI example of removing tags from an
%% accelerator, scroll down to Example. The operation succeeds even if you
...
%%
%% To see an AWS CLI example of updating an accelerator to enable flow logs,
%% scroll down to Example.
