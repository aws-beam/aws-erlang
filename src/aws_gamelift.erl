...
%% Amazon GameLift Realtime, you can quickly configure
%% and set up ready-to-go game servers for your game. Amazon GameLift
...
%% @doc Creates a new script record for your Amazon GameLift Realtime script.
%%
%% Realtime scripts are JavaScript that
%% provide configuration settings and optional custom game logic for your
%% game. The script
%% is deployed when you create a Amazon GameLift Realtime fleet to host your
%% game sessions. Script logic is
...
%% host game sessions through Amazon GameLift. Use this operation with an
%% Anywhere fleet that
%% doesn't use the Amazon GameLift Agent For Anywhere fleets with the
...
%%
%% When
%% processing a placement request, Amazon GameLift looks for the best
