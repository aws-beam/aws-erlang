...
%% or use the Amazon GameLift Realtime Servers. Realtime Servers gives you
%% the ability to quickly stand up lightweight, efficient game servers with
%% the core Amazon GameLift infrastructure already built in.
%%
...
%% Amazon S3 bucket, call <code>CreateBuild</code> and specify a build name,
...
%%
%% <note> When creating a Realtime Servers fleet, we recommend using a
%% minimal version of the Realtime script (see this <a
%% href="https://docs.aws.amazon.com/gamelift/latest/developerguide/realtime-script.html#realtime-script-examples">
%% working code example </a>). This will make it much easier to troubleshoot
%% any fleet creation issues. Once the fleet is active, you can update your
%% Realtime script as needed.
%%
%% </note> If the <code>CreateFleet</code> call is successful, Amazon
%% GameLift performs the following tasks. You can track the process of a
%% fleet by checking the fleet status or by monitoring fleet creation events:
%%
