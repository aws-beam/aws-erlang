...
%% your AWS service quotas. Quotas, also referred to as limits, are the
%% maximum values for a resource, item, or operation. This guide provide
%% descriptions of the Service Quotas actions that you can call from an API.
%% For the Service Quotas user guide, which explains how to use Service
%% Quotas from the console, see <a
...
%% how to download and install them, see the <a
%% href="https://docs.aws.amazon.com/aws.amazon.com/tools">Tools for Amazon
%% Web Services</a> page.
%%
%% </note>
...
%% @doc Disables the Service Quotas template. Once the template is disabled,
%% it does not request quota increases for new accounts in your organization.
...
%% <a>AssociateServiceQuotaTemplate</a>.
%%
...
%% @doc Retrieves the default service quotas values. The Value returned for
...
%% @doc Retrieves the <code>ServiceQuotaTemplateAssociationStatus</code>
%% value from the service. Use this action to determine if the Service Quota
...
%% @doc Returns the details for the specified service quota. This operation
...
%% return an unexpected list of results, even when there are more results
%% available. When this happens, the <code>NextToken</code> response
%% parameter contains a value to pass the next call to the same API to
...
%% @doc Requests a list of the changes to specific service quotas. This
...
%% @doc Lists all service quotas for the specified AWS service. This request
...
%% @doc Lists the AWS services available in Service Quotas. Not all AWS
%% services are available in Service Quotas. To list the see the list of the
%% service quotas for a specific service, use <a>ListServiceQuotas</a>.
...
%% @doc Defines and adds a quota to the service quota template. To add a
%% quota to the template, you must provide the <code>ServiceCode</code>,
...
%% @doc Retrieves the details of a service quota increase request. The
