...
%% @doc Amazon Web Services IoT FleetWise is in preview release and is
%% subject to change.
%%
%% We recommend that you use the service only with test data, and not in
...
%% Web Services SDK or CLI. For more information, see Preview Amazon Web
%% Services SDK and CLI in the Amazon Web Services IoT FleetWise Developer
%% Guide.
%%
%% Amazon Web Services IoT FleetWise is a fully managed service that you can
%% use to collect, model, and transfer vehicle data to the Amazon Web
...
%% only high-value data to the cloud.
%%
...
%% @doc Registers your Amazon Web Services account, IAM, and Amazon
%% Timestream resources so Amazon Web Services IoT FleetWise can transfer
