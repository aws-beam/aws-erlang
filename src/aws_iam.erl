...
%% programmatic API calls to IAM. The Amazon Web Services
%% SDKs consist of libraries and sample code for various programming
%% languages and platforms
%% (for example, Java, Ruby, .NET, iOS, and Android). The SDKs provide a
%% convenient way to
%% create programmatic access to IAM and Amazon Web Services. For example,
%% the SDKs take care of tasks such as
...
%%
%% Alternatively, you can also use the IAM Query API to make direct calls to
%% the IAM
%% service. For more information about calling the IAM Query API, see Making
%% query
%% requests:
%% https://docs.aws.amazon.com/IAM/latest/UserGuide/IAM_UsingQueryAPI.html in
%% the Identity and Access Management User Guide. IAM supports GET and
...
%% strongly
%% recommend that you do not use your Amazon Web Services account access key
%% ID and secret access key for
%% everyday work with IAM. You can use the access key ID and secret access
%% key for an
...
%% you have an
%% existing application that uses Signature Version 2, you do not have to
%% update it to use
%% Signature Version 4. However, some operations now require Signature
%% Version 4. The
%% documentation for operations that require version 4 indicate this
%% requirement.
%%
