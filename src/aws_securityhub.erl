...
%% standards. Security Hub collects security data from Amazon Web Services
%% accounts, services, and
%% integrated third-party products and helps you analyze security trends in
%% your environment
%% to identify the highest priority security issues. For more information
%% about Security Hub, see the
%% Security Hub User
%% Guide
%% :
