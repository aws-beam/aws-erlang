...
-export([accept_administrator_invitation/2,
         ...
         disable_security_hub_feature_v2/3,
         disable_security_hub_feature_v2/4,
         ...
         enable_security_hub_feature_v2/3,
         enable_security_hub_feature_v2/4,
         ...
         get_findings/2,
         get_findings/3,
         get_findings_trends_v2/2,
         get_findings_trends_v2/3,
         get_findings_v2/2,
         get_findings_v2/3,
         ...
         register_connector_v2/2,
         register_connector_v2/3,
...
%%   <<"ScopeConfiguration">> => azure_scope_configuration()
%% }
-type azure_provider_configuration() :: #{binary() => any()}.
...
%%   <<"ScopeConfiguration">> => azure_scope_configuration()
%% }
-type azure_update_configuration() :: #{binary() => any()}.
...
%% }
-type cspm_connector_summary() :: #{binary() => any()}.
...
%%   <<"Message">> => string()
%% }
-type cspm_health_check() :: #{binary() => any()}.
...
%% }
-type cspm_provider_summary() :: #{binary() => any()}.
...
%%   <<"EnablementStatus">> => list(any())
%% }
-type delete_connector_v2_response() :: #{binary() => any()}.
...
%%   <<"UpdatedAt">> => non_neg_integer()
%% }
-type feature_detail() :: #{binary() => any()}.
...
%% }
-type findings_trends_composite_filter() :: #{binary() => any()}.
...
%% }
-type findings_trends_filters() :: #{binary() => any()}.
...
%% }
-type findings_trends_string_filter() :: #{binary() => any()}.
...
%%   <<"EndTime">> := non_neg_integer(),
%%   <<"Filters">> => findings_trends_filters(),
%%   <<"MaxResults">> => integer(),
%%   <<"NextToken">> => string(),
%%   <<"StartTime">> := non_neg_integer()
%% }
-type get_findings_trends_v2_request() :: #{binary() => any()}.
...
%% }
-type get_findings_trends_v2_response() :: #{binary() => any()}.
...
%%   <<"EndTime">> := non_neg_integer(),
%%   <<"Filters">> => resources_trends_filters(),
%%   <<"MaxResults">> => integer(),
%%   <<"NextToken">> => string(),
%%   <<"StartTime">> := non_neg_integer()
%% }
-type get_resources_trends_v2_request() :: #{binary() => any()}.
...
%% }
-type get_resources_trends_v2_response() :: #{binary() => any()}.
...
%%   <<"AuthState">> := string()
%% }
-type register_connector_v2_request() :: #{binary() => any()}.
...
%%   <<"ConnectorId">> => string()
%% }
-type register_connector_v2_response() :: #{binary() => any()}.
...
%% }
-type resource_owner() :: #{binary() => any()}.
...
%%   <<"Id">> => string()
%% }
-type resource_owner_account() :: #{binary() => any()}.
...
%%   <<"Id">> => string()
%% }
-type resource_owner_org() :: #{binary() => any()}.
...
%%   <<"AllResources">> => float()
%% }
-type resources_count() :: #{binary() => any()}.
...
%% }
-type resources_trends_composite_filter() :: #{binary() => any()}.
...
%%   <<"CompositeOperator">> => list(any())
%% }
-type resources_trends_filters() :: #{binary() => any()}.
...
%% }
-type resources_trends_metrics_result() :: #{binary() => any()}.
...
%%   <<"Filter">> => string_filter()
%% }
-type resources_trends_string_filter() :: #{binary() => any()}.
...
%% }
-type resources_trends_values() :: #{binary() => any()}.
...
%%   <<"SecretArn">> => string()
%% }
-type service_now_update_configuration() :: #{binary() => any()}.
...
%%   <<"Unknown">> => float()
%% }
-type severity_trends_count() :: #{binary() => any()}.
...
%% }
-type trends_metrics_result() :: #{binary() => any()}.
...
%%   <<"EnablementStatus">> => list(any())
%% }
-type update_connector_v2_response() :: #{binary() => any()}.
...
%% @doc Creates a connector to a third-party cloud provider in Security Hub
%% CSPM.
%%
%% A connector establishes a connection between Security Hub CSPM and a
...
%% @doc Deletes a CSPM connector.
%%
%% When you delete a connector, Security Hub CSPM stops ingesting findings
%% and resource data from the connected cloud provider environment.
...
delete_connector(Client, ConnectorId, Input) ->
    delete_connector(Client, ConnectorId, Input, []).
...
-spec delete_connector(aws_client:aws_client(), binary() | list(), delete_connector_request(), proplists:proplist()) ->
    ...
    {error, any()} |
    {error, delete_connector_errors(), tuple()}.
delete_connector(Client, ConnectorId, Input0, Options0) ->
    Method = delete,
    Path = ["/connectors/", aws_util:encode_multi_segment_uri(ConnectorId), ""],
    SuccessStatusCode = 200,
    {SendBodyAsBinary, Options1} = proplists_take(send_body_as_binary, Options0, false),
    {ReceiveBodyAsBinary, Options2} = proplists_take(receive_body_as_binary, Options1, false),
    Options = [{send_body_as_binary, SendBodyAsBinary},
  ...
  when is_map(Client), is_map(QueryMap), is_map(HeadersMap), is_list(Options0) ->
    ...
    Query0_ =
      [
        {<<"MaxResults">>, maps:get(<<"MaxResults">>, QueryMap, undefined)},
        {<<"NextToken">>, maps:get(<<"NextToken">>, QueryMap, undefined)},
        {<<"Providers">>, maps:get(<<"Providers">>, QueryMap, undefined)}
      ],
    Query_ = [H || {_, V} = H <- Query0_, V =/= undefined],
...
%% @doc Disables an opt-in feature for the calling account in the current
%% Amazon Web Services Region.
%%
%% The operation is idempotent. If the feature is already disabled, no
%% changes are made. You cannot disable a feature that is managed by an
%% organization policy.
-spec disable_security_hub_feature_v2(aws_client:aws_client(), binary() | list(), disable_security_hub_feature_v2_request()) ->
    {ok, disable_security_hub_feature_v2_response(), tuple()} |
    {error, any()} |
    {error, disable_security_hub_feature_v2_errors(), tuple()}.
disable_security_hub_feature_v2(Client, FeatureName, Input) ->
    disable_security_hub_feature_v2(Client, FeatureName, Input, []).

-spec disable_security_hub_feature_v2(aws_client:aws_client(), binary() | list(), disable_security_hub_feature_v2_request(), proplists:proplist()) ->
    {ok, disable_security_hub_feature_v2_response(), tuple()} |
    {error, any()} |
    {error, disable_security_hub_feature_v2_errors(), tuple()}.
disable_security_hub_feature_v2(Client, FeatureName, Input0, Options0) ->
    Method = delete,
    Path = ["/hubv2/feature/", aws_util:encode_uri(FeatureName), ""],
    SuccessStatusCode = 200,
    {SendBodyAsBinary, Options1} = proplists_take(send_body_as_binary, Options0, false),
    {ReceiveBodyAsBinary, Options2} = proplists_take(receive_body_as_binary, Options1, false),
    Options = [{send_body_as_binary, SendBodyAsBinary},
...
%% @doc Enables an opt-in feature for the calling account in the current
%% Amazon Web Services Region.
%%
%% The service must be enabled before you can enable a feature. The operation
%% is idempotent. If the feature is already enabled, no changes are made. You
%% cannot enable a feature that is managed by an organization policy.
-spec enable_security_hub_feature_v2(aws_client:aws_client(), binary() | list(), enable_security_hub_feature_v2_request()) ->
    {ok, enable_security_hub_feature_v2_response(), tuple()} |
    {error, any()} |
    {error, enable_security_hub_feature_v2_errors(), tuple()}.
enable_security_hub_feature_v2(Client, FeatureName, Input) ->
    enable_security_hub_feature_v2(Client, FeatureName, Input, []).

-spec enable_security_hub_feature_v2(aws_client:aws_client(), binary() | list(), enable_security_hub_feature_v2_request(), proplists:proplist()) ->
    {ok, enable_security_hub_feature_v2_response(), tuple()} |
    {error, any()} |
    {error, enable_security_hub_feature_v2_errors(), tuple()}.
enable_security_hub_feature_v2(Client, FeatureName, Input0, Options0) ->
    Method = post,
    Path = ["/hubv2/feature/", aws_util:encode_uri(FeatureName), ""],
    SuccessStatusCode = 200,
    {SendBodyAsBinary, Options1} = proplists_take(send_body_as_binary, Options0, false),
...
-spec get_connector(aws_client:aws_client(), binary() | list(), map(), map()) ->
    ...
    {error, any()} |
    {error, get_connector_errors(), tuple()}.
get_connector(Client, ConnectorId, QueryMap, HeadersMap)
  when is_map(Client), is_map(QueryMap), is_map(HeadersMap) ->
    get_connector(Client, ConnectorId, QueryMap, HeadersMap, []).
...
-spec get_connector(aws_client:aws_client(), binary() | list(), map(), map(), proplists:proplist()) ->
    ...
    {error, any()} |
    {error, get_connector_errors(), tuple()}.
get_connector(Client, ConnectorId, QueryMap, HeadersMap, Options0)
  when is_map(Client), is_map(QueryMap), is_map(HeadersMap), is_list(Options0) ->
    Path = ["/connectors/", aws_util:encode_multi_segment_uri(ConnectorId), ""],
    SuccessStatusCode = 200,
    {SendBodyAsBinary, Options1} = proplists_take(send_body_as_binary, Options0, false),
...
%% @doc Returns findings trend data based on the specified criteria.
%%
%% This operation helps you analyze patterns and changes in findings over
%% time.
-spec get_findings_trends_v2(aws_client:aws_client(), get_findings_trends_v2_request()) ->
    {ok, get_findings_trends_v2_response(), tuple()} |
    {error, any()} |
    {error, get_findings_trends_v2_errors(), tuple()}.
get_findings_trends_v2(Client, Input) ->
    get_findings_trends_v2(Client, Input, []).

-spec get_findings_trends_v2(aws_client:aws_client(), get_findings_trends_v2_request(), proplists:proplist()) ->
    {ok, get_findings_trends_v2_response(), tuple()} |
    {error, any()} |
    {error, get_findings_trends_v2_errors(), tuple()}.
get_findings_trends_v2(Client, Input0, Options0) ->
    Method = post,
...
%% `ResourceCategory' string filter with comparison set to `EQUALS'
%% and value `AI/ML' in the corresponding `ResourceGroupByRule'.
...
%% @doc Returns resource trend data based on the specified criteria.
%%
%% This operation helps you analyze patterns and changes in resource
%% compliance over time.
-spec get_resources_trends_v2(aws_client:aws_client(), get_resources_trends_v2_request()) ->
    {ok, get_resources_trends_v2_response(), tuple()} |
    {error, any()} |
    {error, get_resources_trends_v2_errors(), tuple()}.
get_resources_trends_v2(Client, Input) ->
    get_resources_trends_v2(Client, Input, []).

-spec get_resources_trends_v2(aws_client:aws_client(), get_resources_trends_v2_request(), proplists:proplist()) ->
    {ok, get_resources_trends_v2_response(), tuple()} |
    {error, any()} |
    {error, get_resources_trends_v2_errors(), tuple()}.
get_resources_trends_v2(Client, Input0, Options0) ->
    Method = post,
...
%% field. For self-hosted AI resources and their host resources, the response
%% also includes `ResourceInfo' with AI-specific details. Self-hosted AI
%% resources use a `ResourceType' with the `SelfHosted::AI::' prefix,
%% such as `SelfHosted::AI::Model', `SelfHosted::AI::Agent',
%% `SelfHosted::AI::InferenceEndpoint', and
%% `SelfHosted::AI::ExternalEndpoint'.
%%
%% If you filter by `ResourceSubCategory', you must also include a
%% `ResourceCategory' string filter with comparison set to `EQUALS'
%% and value `AI/ML' in the same request.
...
%% @doc Lists the CSPM connectors and their metadata for the calling account.
  ...
  when is_map(Client), is_map(QueryMap), is_map(HeadersMap), is_list(Options0) ->
    ...
    Query0_ =
      [
        ...
        {<<"EnablementStatus">>, maps:get(<<"EnablementStatus">>, QueryMap, undefined)},
        {<<"MaxResults">>, maps:get(<<"MaxResults">>, QueryMap, undefined)},
        {<<"NextToken">>, maps:get(<<"NextToken">>, QueryMap, undefined)},
...
%% parameters.
-spec register_connector_v2(aws_client:aws_client(), register_connector_v2_request()) ->
    {ok, register_connector_v2_response(), tuple()} |
    {error, any()} |
    {error, register_connector_v2_errors(), tuple()}.
register_connector_v2(Client, Input) ->
    register_connector_v2(Client, Input, []).

-spec register_connector_v2(aws_client:aws_client(), register_connector_v2_request(), proplists:proplist()) ->
    {ok, register_connector_v2_response(), tuple()} |
    {error, any()} |
    {error, register_connector_v2_errors(), tuple()}.
register_connector_v2(Client, Input0, Options0) ->
    Method = post,
...
%% @doc Updates a CSPM connector's configuration, such as the scope or
...
update_connector(Client, ConnectorId, Input) ->
    update_connector(Client, ConnectorId, Input, []).
...
-spec update_connector(aws_client:aws_client(), binary() | list(), update_connector_request(), proplists:proplist()) ->
    ...
    {error, any()} |
    {error, update_connector_errors(), tuple()}.
update_connector(Client, ConnectorId, Input0, Options0) ->
    Method = patch,
    Path = ["/connectors/", aws_util:encode_multi_segment_uri(ConnectorId), ""],
    SuccessStatusCode = 200,
    {SendBodyAsBinary, Options1} = proplists_take(send_body_as_binary, Options0, false),
...
do_request(Client, Method, Path, Query, Headers0, Input, Options, SuccessStatusCode) ->
    ...
    {URL1, Host} = aws_util:apply_endpoint_url_override(URL0, DefaultHost, PathBin, <<"AWS_ENDPOINT_URL_SECURITYHUB">>),
