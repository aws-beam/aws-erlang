...
%% ```
%% EC2 RebootInstances API call''', `EC2 StopInstances API
%% call', and
%% ```
...
%% instances, Kinesis Data Streams,
...
do_request(Client, Action, Input0, Options) ->
    ...
    {URL, Host} = aws_util:apply_endpoint_url_override(build_url(DefaultHost, Client1), DefaultHost, <<"/">>, <<"AWS_ENDPOINT_URL_CLOUDWATCH_EVENTS">>),
    Headers = [
        {<<"Host">>, Host},
