...
%% be another AWS account, a root user, an IAM user or role, a federated
%% user, an AWS service, or an anonymous user. This guide describes the AWS
%% IAM Access Analyzer operations that you can call programmatically. For
%% general information about Access Analyzer, see the <a
...
%% @doc Creates an archive rule for the specified analyzer. Archive rules
...
%% @doc Deletes the specified analyzer. When you delete an analyzer, Access
