...
%%
%% </li> <li> <code>typeFilter.name</code>: String constraint. The key is
%% <code>swf:typeFilter.name</code>.
%%
%% </li> <li> <code>typeFilter.version</code>: String constraint. The key is
...
%% in then <code>0</code> is returned.
%%
%% <b>Access Control</b>
%%
%% You can use IAM policies to control this action's access to Amazon SWF
...
%% to call this action.
%%
%% </li> <li> Constrain the <code>taskList.name</code> parameter by using a
...
%% attempted.
%%
%% </note> <important> If the <code>cancelRequested</code> flag returns
...
%% <code>Condition</code> element with the appropriate keys.
%%
%% <ul> <li> <code>defaultTaskList.name</code>: String constraint. The key is
%% <code>swf:defaultTaskList.name</code>.
%%
%% </li> <li> <code>name</code>: String constraint. The key is
%% <code>swf:name</code>.
%%
%% </li> <li> <code>version</code>: String constraint. The key is
...
%%
%% <note> If the runId isn't specified, the
...
%%
%% </note> <note> Because this action allows the workflow to properly clean
...
%% provided).
%%
%% <note> If a runId isn't specified, then the
...
%% fails with <code>UnknownResource</code>.
%%
%% </note> <b>Access Control</b>
%%
%% You can use IAM policies to control this action's access to Amazon SWF
...
%% <code>Condition</code> element with the appropriate keys.
%%
%% <ul> <li> <code>tagList.member.0</code>: The key is
%% <code>swf:tagList.member.0</code>.
%%
%% </li> <li> <code>tagList.member.1</code>: The key is
%% <code>swf:tagList.member.1</code>.
%%
%% </li> <li> <code>tagList.member.2</code>: The key is
%% <code>swf:tagList.member.2</code>.
%%
%% </li> <li> <code>tagList.member.3</code>: The key is
%% <code>swf:tagList.member.3</code>.
%%
%% </li> <li> <code>tagList.member.4</code>: The key is
%% <code>swf:tagList.member.4</code>.
%%
%% </li> <li> <code>taskList</code>: String constraint. The key is
%% <code>swf:taskList.name</code>.
%%
%% </li> <li> <code>workflowType.name</code>: String constraint. The key is
%% <code>swf:workflowType.name</code>.
%%
%% </li> <li> <code>workflowType.version</code>: String constraint. The key
%% is <code>swf:workflowType.version</code>.
...
%%
%% </note> <note> You should consider using
