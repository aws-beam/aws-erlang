...
%% AppFabric Administration Guide. For more information about using the
%% Command Line Interface (CLI) to manage your AppFabric resources, see the
%% AppFabric section of the CLI Reference.
