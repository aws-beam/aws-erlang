...
%% @doc Adds the specified tags to the specified load balancer. Each load
...
%% @doc Creates one or more listeners for the specified load balancer. If a
...
%% @doc Deletes the specified policy from the specified load balancer. This
...
%% @doc Describes the specified the load balancers. If no load balancers are
...
request(Client, Action, Input0, Options) ->
    ...
    Host = get_host(<<"elasticloadbalancing">>, Client1),
