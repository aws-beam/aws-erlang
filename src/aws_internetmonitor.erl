...
%% applications hosted on Amazon Web Services and your end users, reducing
%% the time it takes for you to diagnose these issues, from days to minutes.
%%
...
%% issues, and then take action to improve your end users' experience,
%% for example, by switching to other Amazon Web Services services or
%% rerouting traffic to your workload through differentAmazon Web Services
%% Regions.
%%
%% If the issue is caused by the Amazon Web Services network, you'll
%% automatically receive an Amazon Web Services Health Dashboard notification
%% with the steps that Amazon Web Services is taking to mitigate the problem.
%% To support integrating health information for geographies and networks
%% specific to your application, Internet Monitor delivers measurements to
%% CloudWatch Logs and CloudWatch Metrics. Internet Monitor also sends health
%% events to Amazon EventBridge, so you can set up notifications. Internet
%% Monitor monitors internet connectivity for your application through Amazon
%% Virtual Private Clouds (VPCs), Amazon CloudFront distributions, and Amazon
...
%% that you add: Virtual Private Clouds (VPCs), Amazon CloudFront
%% distributions, and WorkSpaces directories.
%%
...
%% impairing traffic. Internet Monitor can also diagnose whether the
%% impairment is on the Amazon Web Services network or is an issue with an
...
%%
%% You can update a monitor to add or remove resources, or to change the
