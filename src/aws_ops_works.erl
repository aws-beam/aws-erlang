...
%%
%% Welcome to the <i>AWS OpsWorks Stacks API Reference</i>. This guide
...
%% @doc Describes the available AWS OpsWorks Stacks agent versions. You must
...
%% are created by using the <a>CreateInstance</a> API. For example,
