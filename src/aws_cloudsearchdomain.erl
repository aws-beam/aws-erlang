...
%% <code>Search</code>, and <code>Suggest</code> requests are
...
%%
%% <ul> <li><code>simple</code>: search all <code>text</code> and
...
%% query parser.</li> </ul> For more information, see <a
...
%% @doc Retrieves autocomplete suggestions for a partial query string. You
...
%% @doc Posts a batch of documents to a search domain for indexing. A
%% document batch is a collection of add and delete operations that represent
%% the documents you want to add, update, or delete from your domain. Batches
