...
%% @doc <note> This is the latest version of the <b>AWS WAF</b> API, released
%% in November, 2019. The names of the entities that you use to access this
%% API, like endpoints and namespaces, all have the versioning information
...
%% strings, API Gateway, CloudFront, or the Application Load Balancer
...
%% AWS WAF features and an overview of how to use AWS WAF, see the <a
...
%% you need to distinguish the scope, you specify a <code>Scope</code>
%% parameter and set it to <code>CLOUDFRONT</code> or <code>REGIONAL</code>.
%%
...
%% @doc <note> This is the latest version of <b>AWS WAF</b>, named AWS WAFV2,
%% released in November, 2019. For information, including how to migrate your
%% AWS WAF resources from the prior release, see the <a
%% href="https://docs.aws.amazon.com/waf/latest/developerguide/waf-chapter.html">AWS
%% WAF Developer Guide</a>.
%%
...
%% requirements for the rules you want to use in a <a>RuleGroup</a> or
%% <a>WebACL</a>.
%%
...
%% WAF Developer Guide</a>.
%%
%% </note> Creates an <a>IPSet</a>, which you use to identify web requests
...
%% WAF Developer Guide</a>.
%%
%% </note> Creates a <a>RegexPatternSet</a>, which you reference in a
...
%% WAF Developer Guide</a>.
%%
%% </note> Creates a <a>RuleGroup</a> per the specifications provided.
%%
...
%% WAF Developer Guide</a>.
%%
%% </note> Creates a <a>WebACL</a> per the specifications provided.
%%
...
%% WAF Developer Guide</a>.
%%
%% </note> Deletes the specified <a>IPSet</a>.
...
%% WAF Developer Guide</a>.
%%
%% </note> Deletes the <a>LoggingConfiguration</a> from the specified web
%% ACL.
...
%% WAF Developer Guide</a>.
%%
%% </note> Deletes the specified <a>RegexPatternSet</a>.
...
%% WAF Developer Guide</a>.
%%
%% </note> Deletes the specified <a>RuleGroup</a>.
...
%% WAF Developer Guide</a>.
%%
%% </note> Deletes the specified <a>WebACL</a>.
%%
%% You can only use this if <code>ManagedByFirewallManager</code> is false in
%% the specified <a>WebACL</a>.
...
%% WAF Developer Guide</a>.
%%
%% </note> Provides high-level information for a managed rule group,
%% including descriptions of the rules.
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves the specified <a>IPSet</a>.
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves the keys that are currently blocked by a rate-based
%% rule. The maximum number of managed keys that can be blocked for a single
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves the specified <a>RegexPatternSet</a>.
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves the specified <a>RuleGroup</a>.
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves the specified <a>WebACL</a>.
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves the <a>WebACL</a> for the specified resource.
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves an array of <a>IPSetSummary</a> objects for the IP sets
%% that you manage.
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves an array of your <a>LoggingConfiguration</a> objects.
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves an array of <a>RegexPatternSetSummary</a> objects for
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves an array of <a>RuleGroupSummary</a> objects for the rule
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves the <a>TagInfoForResource</a> for the specified
...
%% WAF Developer Guide</a>.
%%
%% </note> Retrieves an array of <a>WebACLSummary</a> objects for the web
...
%% WAF Developer Guide</a>.
%%
%% </note> Enables the specified <a>LoggingConfiguration</a>, to start
...
%% @doc Attaches an IAM policy to the specified resource. Use this to share a
...
%%
%% </li> <li> The ARN in the request must be a valid WAF <a>RuleGroup</a> ARN
...
%% WAF Developer Guide</a>.
%%
%% </note> Updates the specified <a>IPSet</a>.
...
%% WAF Developer Guide</a>.
%%
%% </note> Updates the specified <a>RegexPatternSet</a>.
...
%% WAF Developer Guide</a>.
%%
%% </note> Updates the specified <a>RuleGroup</a>.
%%
%% A rule group defines a collection of rules to inspect and control web
%% requests that you can use in a <a>WebACL</a>. When you create a rule
%% group, you define an immutable capacity limit. If you update a rule group,
...
%% WAF Developer Guide</a>.
%%
%% </note> Updates the specified <a>WebACL</a>.
%%
%% A Web ACL defines a collection of rules to use to inspect and control web
%% requests. Each rule has an action defined (allow, block, or count) for
%% requests that match the statement of the rule. In the Web ACL, you assign
