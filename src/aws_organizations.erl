...
%% forum: https://forums.aws.amazon.com/forum.jspa?forumID=219. For more
%% information about the Amazon Web Services Support forums, see Forums Help:
...
%% the resources won't be available unless you contact Amazon Web
%% Services Support to reopen the account. After 90 days, you can't
%% reopen an account.
...
do_request(Client, Action, Input0, Options) ->
    ...
    {URL, Host} = aws_util:apply_endpoint_url_override(build_url(DefaultHost, Client1), DefaultHost, <<"/">>, <<"AWS_ENDPOINT_URL_ORGANIZATIONS">>),
    Headers = [
        {<<"Host">>, Host},
