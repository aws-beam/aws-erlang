...
%% engage with
%% your recipients across multiple messaging channels. The Amazon Pinpoint
%% SMS and
...
%% event options
%% are Amazon CloudWatch, Amazon Kinesis Data Firehose, or Amazon SNS. For
%% example,
...
%% information, see Message Parts per
%% Second (MPS) limits:
...
%% resource. For more
%% information about tags, see Tagging Amazon Pinpoint resources:
