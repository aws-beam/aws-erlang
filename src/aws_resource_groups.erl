...
%% @doc <fullname>AWS Resource Groups</fullname>
%%
...
%% @doc Creates a resource group with the specified name and description. You
...
%% @doc Deletes the specified resource group. Deleting a resource group does
...
%%
%% <ul> <li> <code>AWS::EC2::CapacityReservationPool</code> - Amazon EC2
%% capacity reservation pools. For more information, see <a
...
%% @doc Returns a list of AWS resource identifiers that matches tne specified
...
%% @doc Adds tags to a resource group with the specified ARN. Existing tags
...
%% @doc Updates the description for an existing group. You cannot update the
