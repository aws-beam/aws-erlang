...
%% communicating with
%% Amazon Web Services, use the FIPS endpoint in your preferred Amazon Web
%% Services Region. For more information about the
%% available FIPS endpoints, see Service endpoints:
%% https://docs.aws.amazon.com/general/latest/gr/kms.html#kms_region in the
%% Key Management Service topic of
...
%% and every year thereafter. You can monitor rotation of the key material
%% for your KMS keys in
