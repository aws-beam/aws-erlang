...
%% @doc AWS Clean Rooms is in preview release and is subject to change.
%%
...
%% into the combined data without either party getting access to the other
%% party's raw data.
%%
...
%%
%% The removed member is placed in the Removed status and can't interact with
%% the collaboration. The removed member's data is inaccessible to active
