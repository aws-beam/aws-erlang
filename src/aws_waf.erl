...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of an `UpdateByteMatchSet' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of an `UpdateGeoMatchSet' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of an `UpdateIPSet' request.
%%
...
%% drops below 1,000 for a five-minute period, AWS WAF no longer blocks the
%% requests.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of a `CreateRule' request.
%%
%% </li> <li> Submit a `CreateRateBasedRule' request.
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of an `UpdateRule' request.
%%
...
%% the part of a web request that you want AWS WAF to inspect, such as the
%% values of the `User-Agent' header or the query string. For example, you
%% can create a `RegexMatchSet' that contains a `RegexMatchTuple' that looks
%% for any requests with `User-Agent' headers that match a `RegexPatternSet'
%% with pattern `B[a@]dB[o0]t'. You can then configure AWS WAF to reject
%% those requests.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of an `UpdateRegexMatchSet' request.
%%
%% </li> <li> Submit an `UpdateRegexMatchSet' request to specify the part of
%% the request that you want AWS WAF to inspect (for example, the header or
%% the URI) and the value, using a `RegexPatternSet', that you want AWS WAF
%% to watch for.
%%
%% </li> </ol> For more information about how to use the AWS WAF API to allow
%% or block HTTP requests, see the AWS WAF Developer Guide.
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of an `UpdateRegexPatternSet' request.
%%
...
%% header
%%
%% </li> </ul> You then add the `Rule' to a `WebACL' and specify that you
%% want to blocks requests that satisfy the `Rule'. For a request to be
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of an `UpdateSizeConstraintSet' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of an `UpdateSqlInjectionMatchSet' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of a `CreateWebACL' request.
%%
...
%%
%% </li> <li> Submit an `UpdateWebACL' request to specify the `Rules' that
%% you want to include in the `WebACL', to specify the default action, and to
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of an `UpdateXssMatchSet' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of a `DeleteByteMatchSet' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of a `DeleteIPSet' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of a `DeleteRateBasedRule' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of a `DeleteRegexMatchSet' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of a `DeleteRuleGroup' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of a `DeleteSizeConstraintSet' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of a `DeleteSqlInjectionMatchSet' request.
%%
...
%%
%% </li> <li> Use `GetChangeToken' to get the change token that you provide
%% in the `ChangeToken' parameter of a `DeleteXssMatchSet' request.
%%
...
%% blocked, the `User-Agent' header in the request must contain the value
...
%% that matches web requests in which the length of the `User-Agent' header
...
%%
%% <ul> <li> A default action for the `WebACL', either `ALLOW' or `BLOCK'.
...
%% replace one `Rule' with another, you delete the existing `Rule' and add
%% the new one.
%%
...
%%
%% </li> <li> The order in which you want AWS WAF to evaluate the `Rules' in
%% a `WebACL'. If you add more than one `Rule' to a `WebACL', AWS WAF
...
%% your `ActivatedRule' , you can exclude specific rules from that rule
%% group.
%%
...
%% `XssMatchSet' with the applicable settings, and then configure AWS WAF to
%% block the requests.
%%
%% To create and configure an `XssMatchSet', perform the following steps:
%%
