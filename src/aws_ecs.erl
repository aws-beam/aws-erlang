...
%% first container instance. However, you can create your own cluster with a
...
%% balancer are considered healthy if they're in the `RUNNING' state and are
...
%% information, see Cluster Query Language in the Amazon Elastic Container
...
%% For more information, see Elastic Network Interface Trunking in the Amazon
%% Elastic Container Service Developer Guide.
%%
...
%% defaults, see Amazon ECS Task Definitions in the Amazon Elastic Container
%% Service Developer Guide.
%%
...
%% reference. If you specify the `awsvpc' network mode, the task is allocated
%% an elastic network interface, and you must specify a
%% `NetworkConfiguration' when you create a service or run a task with the
%% task definition. For more information, see Task Networking in the Amazon
%% Elastic Container Service Developer Guide.
...
%% information, see Amazon ECS Container Agent Configuration in the Amazon
%% Elastic Container Service Developer Guide.
...
%% count, the deployment configuration, the network configuration, load
%% balancers, service registries, enable ECS managed tags option, propagate
%% tags option, task placement constraints and strategies, and the task
...
%% constraints and strategies, enable ECS managed tags option, and propagate
%% tags can be updated using this API. If the network configuration, platform
%% version, task definition, or load balancer need to be updated, create a
%% new CodeDeploy deployment. For more information, see CreateDeployment in
%% the CodeDeploy API Reference.
%%
