...
%% @doc <fullname>Amazon Neptune</fullname>
%%
...
%% @doc Adds metadata tags to an Amazon Neptune resource. These tags can also
...
%% @doc Creates an event notification subscription. This action requires a
...
%% @doc Deletes a specified DBParameterGroup. The DBParameterGroup to be
...
%% @doc You can call <a>DescribeValidDBInstanceModifications</a> to learn
...
%% @doc Modify a setting for a DB cluster. You can change one or more
...
%% Neptune console or the <a>DescribeDBClusterParameters</a> command to
...
%% your DB instance, call <a>DescribeValidDBInstanceModifications</a> before
%% you call <a>ModifyDBInstance</a>.
...
%% DB parameter group as the default parameter group. This allows Amazon
%% Neptune to fully complete the modify action before the parameter group is
...
%% @doc Modifies an existing event notification subscription. Note that you
...
%% that DB cluster. You must invoke the <a>CreateDBInstance</a> action to
...
%% @doc Stops an Amazon Neptune DB cluster. When you stop a DB cluster,
