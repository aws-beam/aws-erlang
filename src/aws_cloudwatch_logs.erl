...
%% @doc Associates the specified KMS key with the specified log group.
%%
...
%% @doc Disassociates the associated KMS key from the specified log group.
%%
...
%%
%% </li> <li> There is a quota of five requests per second per log stream.
