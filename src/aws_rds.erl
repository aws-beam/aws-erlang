...
%%
%% <ul> <li> Oracle Database 12.1 Enterprise Edition with the January 2021 or
%% later RU/RUR
%%
%% </li> <li> Oracle Database 19c Enterprise Edition with the January 2021 or
%% later RU/RUR
%%
%% </li> </ul> Amazon RDS, which is a fully managed service, supplies the
%% Amazon Machine Image (AMI) and database software. The Amazon RDS database
%% software is preinstalled, so you need only select a DB engine and version,
