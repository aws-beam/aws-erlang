...
%% for the `AWS::Config::ResourceCompliance' resource type before
%% deleting rules, and re-enable recording after the rules have been deleted.
%%
...
%%
%% For more information, see Recording Amazon Web Services Resources:
...
do_request(Client, Action, Input0, Options) ->
    ...
    {URL, Host} = aws_util:apply_endpoint_url_override(build_url(DefaultHost, Client1), DefaultHost, <<"/">>, <<"AWS_ENDPOINT_URL_CONFIG_SERVICE">>),
    Headers = [
        {<<"Host">>, Host},
