...
%% user's identity resides. For example, if your user's identity is
%% in us-east-1, make the API call in us-east-1. For more information about
%% managing identities in Amazon Quick Sight, see Identity and access
%% management in Amazon Quick Sight:
%% https://docs.aws.amazon.com/quicksight/latest/userguide/identity.html in
...
do_request(Client, Method, Path, Query, Headers0, Input, Options, SuccessStatusCode) ->
    ...
    {URL1, Host} = aws_util:apply_endpoint_url_override(URL0, DefaultHost, PathBin, <<"AWS_ENDPOINT_URL_QUICKSIGHT">>),
