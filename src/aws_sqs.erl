...
%% size (the
%% sum of the individual lengths of all of the batched messages) are both 1
%% MiB
%% 1,048,576 bytes.
%%
%% A message can include only XML, JSON, and unformatted text. The following
...
do_request(Client, Action, Input0, Options) ->
    ...
    {URL, Host} = aws_util:apply_endpoint_url_override(build_url(DefaultHost, Client1), DefaultHost, <<"/">>, <<"AWS_ENDPOINT_URL_SQS">>),
    Headers = [
        {<<"Host">>, Host},
