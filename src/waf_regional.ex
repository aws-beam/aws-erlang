...
%% @doc <note> This is <b>AWS WAF Classic Regional</b> documentation. For
...
%%
%% </note> This is the <i>AWS WAF Regional Classic API Reference</i> for
%% using AWS WAF Classic with the AWS resources, Elastic Load Balancing (ELB)
...
%% protecting Elastic Load Balancing (ELB) Application Load Balancers and API
%% Gateway APIs. You can use these actions and data types by means of the
%% endpoints listed in <a
...
request(Client, Action, Input, Options) ->
    ...
    Host = get_host(<<"waf-regional">>, Client1),
    URL = get_url(Host, Client1),
    Headers = [
        {<<"Host">>, Host},
        {<<"Content-Type">>, <<"application/x-amz-json-1.1">>},
        {<<"X-Amz-Target">>, << <<"AWSWAF_Regional_20161128.">>/binary, Action/binary>>}
    ],
