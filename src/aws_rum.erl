...
%%
%% Each app monitor can have one resource-based policy. The maximum size of
%% the policy is 4 KB. To learn more about using resource policies with RUM,
%% see Using resource-based policies with CloudWatch RUM:
...
do_request(Client, Method, Path, Query, Headers0, Input, Options, SuccessStatusCode) ->
    ...
    {URL1, Host} = aws_util:apply_endpoint_url_override(URL0, DefaultHost, PathBin, <<"AWS_ENDPOINT_URL_RUM">>),
