...
%%   <<"targetRate">> => float()
%% }
-type abandonment_rate_pacing_config() :: #{binary() => any()}.
...
do_request(Client, Method, Path, Query, Headers0, Input, Options, SuccessStatusCode) ->
    ...
    {URL1, Host} = aws_util:apply_endpoint_url_override(URL0, DefaultHost, PathBin, <<"AWS_ENDPOINT_URL_CONNECTCAMPAIGNSV2">>),
